...
-- | This module is a temporary home for the Shape type so that we can
-- compile the modified Shape.hs
module World.Shape.Temporary (Shape, IsShape(..), toShape, Point, normal, intersection, difference) where
